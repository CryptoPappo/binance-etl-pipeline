...
st.title("Binance Trades Analysis Dashboard")
...
st.header("Page 1 — Market Overview & Price Dynamics", divider=True)
...
st.header("Page 2 — Correlations & Order Flow", divider=True)
...
st.header("Page 3 — Statistical Distributions")
